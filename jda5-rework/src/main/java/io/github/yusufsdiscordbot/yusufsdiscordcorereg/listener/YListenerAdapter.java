package io.github.yusufsdiscordbot.yusufsdiscordcorereg.listener;

import io.github.yusufsdiscordbot.yusufsdiscordcorereg.interaction.event.YButtonInteractionEvent;
import io.github.yusufsdiscordbot.yusufsdiscordcorereg.interaction.event.YCommandAutoCompleteInteractionEvent;
...
/**
 * An abstract implementation of {@link net.dv8tion.jda.api.hooks.EventListener EventListener} which
 * divides {@link net.dv8tion.jda.api.events.Event Events} for you. You should
 * <b><u>override</u></b> the methods provided by this class for your event listener implementation.
 *
 * <h2>Example:</h2>
 * 
 * <pre>
 * <code>
 * public class MyReadyListener extends YListenerAdapter
 * {
 *    {@literal @Override}
 ...
 */
public abstract class YListenerAdapter implements EventListener {
    ...
    // Interaction Events
    public void onSlashCommandInteraction(@Nonnull YSlashCommandInteractionEvent event) {}

    public void onUserContextInteraction(@Nonnull UserContextInteractionEvent event) {}

    public void onMessageContextInteraction(@Nonnull MessageContextInteractionEvent event) {}

    public void onButtonInteraction(@Nonnull YButtonInteractionEvent event) {}

    public void onSelectMenuInteraction(@Nonnull SelectMenuInteractionEvent event) {}

    public void onCommandAutoCompleteInteraction(
            @Nonnull YCommandAutoCompleteInteractionEvent event) {}

    public void onModalInteraction(@Nonnull YModalInteractionEvent event) {}
    ...
    public final void onEvent(@Nonnull GenericEvent event) {
        ...
        for (Class<?> clazz : ClassWalker.range(event.getClass(), GenericEvent.class)) {
            if (unresolved.contains(clazz))
                continue;
            MethodHandle mh = methods.computeIfAbsent(clazz, YListenerAdapter::findMethod);
            if (mh == null) {

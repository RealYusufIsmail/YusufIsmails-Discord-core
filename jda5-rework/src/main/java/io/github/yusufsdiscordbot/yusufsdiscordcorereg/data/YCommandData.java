package io.github.yusufsdiscordbot.yusufsdiscordcorereg.data;
...
public class YCommandData implements CommandData {
    ...
    @NotNull
    @Override
    public YCommandData setName(@NotNull String name) {
        return new YCommandData(data.setName(name));
    }
    ...
    @NotNull
    @Override
    public YCommandData setDefaultEnabled(boolean enabled) {
        return new YCommandData(data.setDefaultEnabled(enabled));
    }

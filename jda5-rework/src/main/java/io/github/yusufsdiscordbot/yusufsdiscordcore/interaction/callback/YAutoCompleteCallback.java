 ...
 *
 * <p>
 * Auto-complete must be enabled on {@link OptionData options} via
 * {@link OptionData#setAutoComplete(boolean)}. When a user inputs auto-complete options, you will
 * receive these interactions and can provide up to {@value OptionData#MAX_CHOICES} suggestions for
 * the user to pick from. You can also use {@link #replyChoices(Command.Choice...)} without
 * parameters to acknowledge the interaction with 0 choices.
 */
public interface YAutoCompleteCallback extends YInteraction {
    /**
     * Reply with up to {@value OptionData#MAX_CHOICES} choices which can be picked from by the
     * user. <br>
     ...
     * The user may continue writing inputs instead of using one of your choices.
     *
     * @param name The choice name to show to the user, 1-{@value OptionData#MAX_CHOICE_NAME_LENGTH}
     *        characters
     ...
     *         <li>{@code null} is provided</li>
     *         <li>More than {@value OptionData#MAX_CHOICES} are added</li>
     *         <li>The choice name is empty or longer than
     *         {@value OptionData#MAX_CHOICE_NAME_LENGTH}</li>
     ...
     *         {@value OptionData#MAX_CHOICE_NAME_LENGTH}</li>
     *         <li>The option type is incompatible with the choice type</li>
     *         <li>The value of is not between {@value OptionData#MIN_NEGATIVE_NUMBER} and
     *         {@value OptionData#MAX_POSITIVE_NUMBER}</li>
     *         </ul>
     *
     * @return {@link AutoCompleteCallbackAction}
     ...
     *
     * <p>
     * The provided strings will be used as value and name for the
     ...
     *
     * <p>
     * The string values of the provided longs will be used as value and name for the
     * {@link net.dv8tion.jda.api.interactions.commands.Command.Choice Choices}.
     *
     * @param choices The choice suggestions to present to the user
     *
     ...
     *
     * <p>
     * The string values of the provided doubles will be used as value and name for the
     * {@link net.dv8tion.jda.api.interactions.commands.Command.Choice Choices}.
     *
     * @param choices The choice suggestions to present to the user
     *

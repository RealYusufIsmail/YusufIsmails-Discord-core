...
public class YSlashCommandData implements SlashCommandData {
    ...
    @NotNull
    @Override
    public SlashCommandData setName(@NotNull String name) {
        return data.setName(name);
    }

    @NotNull
    @Override
    public SlashCommandData setDefaultEnabled(boolean enabled) {
    ...
    @NotNull
    @Override
    public SlashCommandData setDescription(@NotNull String description) {
        return data.setDescription(description);
    }
    ...
    @NotNull
    @Override
    public SlashCommandData addOptions(@NotNull OptionData... options) {
        return data.addOptions(options);
    }
    ...
    @NotNull
    @Override
    public SlashCommandData addSubcommands(@NotNull SubcommandData... subcommands) {
    ...
    @NotNull
    @Override
    public SlashCommandData addSubcommandGroups(@NotNull SubcommandGroupData... groups) {
        return data.addSubcommandGroups(groups);
    }

...
public class YGenericInteractionCreateEvent extends YModalInteraction {
    private final GenericInteractionCreateEvent event;

    public YGenericInteractionCreateEvent(GenericInteractionCreateEvent event,
            IReplyCallback callback, ModalInteraction interaction, IMessageEditCallback callback1) {
        super(callback, interaction, callback1);
        this.event = event;
    }
    ...
    public YGuild getGuild() {
        return new YGuild(event.getGuild());
    }
    ...
    public YUser getUser() {
        return new YUser(event.getUser());
    }
    ...
    public YMember getMember() {
        return new YMember(event.getMember());
    }

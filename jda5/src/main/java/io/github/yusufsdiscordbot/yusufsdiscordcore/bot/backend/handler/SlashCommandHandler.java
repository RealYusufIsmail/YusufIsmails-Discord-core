package io.github.yusufsdiscordbot.yusufsdiscordcore.bot.backend.handler;
...
public abstract class SlashCommandHandler extends BaseHandler {
    ...
    private void addSlashCommand(@NotNull SlashCommandExtender command) {
        ...
        checkIfBuildIsNull(command.build());
    ...
    public void onSlashCommandInteraction(@NotNull SlashCommandInteractionEvent event) {
        ...
        if (cmd.build().getUserPerms() != null
            ...
            cmd.onSlashCommandInteraction(new YSlashCommandInteractionEvent(cmd, event));
        }

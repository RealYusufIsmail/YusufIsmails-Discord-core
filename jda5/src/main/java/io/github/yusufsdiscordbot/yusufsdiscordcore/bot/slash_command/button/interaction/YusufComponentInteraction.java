...
public class YusufComponentInteraction {
    ...
    public YusufInteraction getInteraction() {
        return new YusufInteraction(componentInteraction.getHook().getInteraction());
    }
     ...
     */
    @NotNull
    public UpdateInteractionAction editComponents(@NotNull Collection<? extends ComponentLayout> components) {
     ...
     */
    @NotNull
    public UpdateInteractionAction editMessageEmbeds(@NotNull Collection<? extends MessageEmbed> embeds) {
     ...
     */
    @NotNull
    public UpdateInteractionAction editMessageFormat(@NotNull String format, @NotNull Object... args) {
